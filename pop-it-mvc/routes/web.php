...
Route::add('GET', '/courses', [Controller\Site::class, 'disciplines'])->middleware('auth');
...
Route::add(['GET', 'POST'], '/create_groops', [Controller\Site::class, 'create_groops']);
Route::add(['GET', 'POST'], '/create_disciplines', [Controller\Site::class, 'create_disciplines']);
Route::add(['GET', 'POST'], '/create_grades', [Controller\Site::class, 'create_grades']);
